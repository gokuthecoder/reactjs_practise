              ...
              <div id="kt_aside" className="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
                ...
                <div className="aside-logo flex-column-auto" id="kt_aside_logo">
                  ...
                  <a href="../../demo1/dist/index.html">
                    <img alt="Logo" src="assets/media/logos/ShopBag.svg" className="h-25px logo" />
                  </a>
                  {/*end::Logo*/}
                  {/*begin::Aside toggler*/}
                    ...
                    <div className="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                      <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                        ...
                        <div className="menu-sub menu-sub-accordion menu-active-bg">
                          ...
                          <div className="menu-inner flex-column collapse" id="kt_aside_menu_collapse">
                            <div className="menu-item">
                          ...
                          <div className="menu-item">
                            <div className="menu-content">
                              <a className="btn btn-flex btn-color-success fs-base p-0 ms-2 mb-2 collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_aside_menu_collapse" data-kt-toggle-text="Show Less">
                        ...
                        <div className="menu-sub menu-sub-accordion menu-active-bg">
                          ...
                          <div data-kt-menu-trigger="click" className="menu-item here show menu-accordion">
                            ...
                            <div className="menu-sub menu-sub-accordion menu-active-bg">
                              ...
                              <div className="menu-item">
                                <a className="menu-link active" href="../../demo1/dist/pages/blog/post.html">
                                  <span className="menu-bullet">
                                    <span className="bullet bullet-dot" />
                                  </span>
                      ...
                      <div className="menu-item">
                        <a className="menu-link" href="../../demo1/dist/documentation/getting-started/changelog.html">
                          ...
                          <span className="menu-title">Changelog v8.0.38</span>
                        </a>
                      </div>
                    </div>
                    {/*end::Menu*/}
                  ...
                  <div className="container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    <div className="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                      <a href="../../demo1/dist/index.html" className="d-lg-none">
                        <img alt="Logo" src="assets/media/logos/ShopBag1.svg" className="h-30px" />
                      </a>
                    </div>
                    {/*end::Mobile logo*/}
                    {/*begin::Wrapper*/}
                    <div className="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                          ...
                          <div className="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                            <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" className="menu-item menu-lg-down-accordion me-lg-1">
                              ...
                              <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div className="menu-item">
                                  <a className="menu-link py-3" href="../../demo1/dist/index.html">
                                    <span className="menu-bullet">
                                      <span className="bullet bullet-dot" />
                                    </span>
                                    <span className="menu-title">Multipurpose</span>
                              ...
                              <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item here show menu-lg-down-accordion">
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/pages/user-profile/overview.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Overview</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/pages/user-profile/projects.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Projects</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/pages/user-profile/campaigns.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Campaigns</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/pages/user-profile/documents.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Documents</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/pages/user-profile/followers.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Followers</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/pages/user-profile/activity.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Activity</span>
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item here show menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link active py-3" href="../../demo1/dist/pages/blog/post.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Blog Post</span>
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/pages/pricing/pricing-1.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Pricing 1</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/pages/pricing/pricing-2.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Pricing 2</span>
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/pages/faq/classic.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Classic</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/pages/about.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">About Us</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/pages/contact.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Contact Us</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/pages/team.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Our Team</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/pages/licenses.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Licenses</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/pages/sitemap.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Sitemap</span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/account/logs.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Logs</span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/basic/sign-in.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Sign-in</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/basic/sign-up.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Sign-up</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/basic/two-steps.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Two-steps</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/basic/password-reset.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Password Reset</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/basic/new-password.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">New Password</span>
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/aside/sign-in.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Sign-in</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/aside/sign-up.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Sign-up</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/aside/two-steps.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Two-steps</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/aside/password-reset.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Password Reset</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/aside/new-password.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">New Password</span>
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/dark/sign-in.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Sign-in</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/dark/sign-up.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Sign-up</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/dark/two-steps.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Two-steps</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/dark/password-reset.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Password Reset</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/layouts/dark/new-password.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">New Password</span>
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/extended/two-factor-authentication.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Two Factor Auth</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/authentication/general/password-confirmation.html">
                                            ...
                                            <span className="menu-title">Password
                                              Confirmation</span>
                                          </a>
                                        </div>
                                        <div className="menu-item">
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                          ...
                                          <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/general/invite-friends.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Invite
                                                  Friends</span>
                                              </a>
                                            </div>
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/general/view-users.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">View
                                                  Users</span>
                                              </a>
                                            </div>
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/general/upgrade-plan.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Upgrade
                                                  Plan</span>
                                              </a>
                                            </div>
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/general/share-earn.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Share &amp;
                                                  Earn</span>
                                              </a>
                                            </div>
                                          </div>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                          ...
                                          <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/forms/new-target.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                            ...
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/forms/new-card.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">New Card</span>
                                            ...
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/forms/new-address.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">New
                                            ...
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/forms/create-api-key.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Create API
                                                  Key</span>
                                              </a>
                                            </div>
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/forms/bidding.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Bidding</span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                          ...
                                          <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/wizards/two-factor-authentication.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Two Factor
                                                  Auth</span>
                                              </a>
                                            </div>
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/wizards/create-app.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Create
                                                  App</span>
                                              </a>
                                            </div>
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/wizards/create-campaign.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Create
                                            ...
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/wizards/create-account.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Create
                                            ...
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/wizards/create-project.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Create
                                            ...
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/wizards/offer-a-deal.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Offer a
                                                  Deal</span>
                                              </a>
                                            </div>
                                          </div>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                          ...
                                          <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/search/users.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Users</span>
                                            ...
                                            <div className="menu-item">
                                              <a className="menu-link py-3" href="../../demo1/dist/utilities/modals/search/select-location.html">
                                                <span className="menu-bullet">
                                                  <span className="bullet bullet-dot" />
                                                </span>
                                                <span className="menu-title">Select
                                                  Location</span>
                                              </a>
                                            </div>
                                          </div>
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/search/horizontal.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Horizontal</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/search/vertical.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Vertical</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/search/users.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Users</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/search/select-location.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Location</span>
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/wizards/horizontal.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Horizontal</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/wizards/vertical.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Vertical</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/wizards/two-factor-authentication.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Two Factor Auth</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/wizards/create-app.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Create App</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/wizards/create-campaign.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Create Campaign</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/wizards/create-account.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Create Account</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/wizards/create-project.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Create Project</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/utilities/wizards/offer-a-deal.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Offer a Deal</span>
                            ...
                            <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" className="menu-item menu-lg-down-accordion me-lg-1">
                              ...
                              <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/projects/list.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">My Projects</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/projects/project.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">View Project</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/projects/targets.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Targets</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/projects/budget.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Budget</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/projects/users.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Users</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/projects/files.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Files</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/projects/activity.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Activity</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/projects/settings.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Settings</span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/catalog/products.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Products</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/catalog/categories.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Categories</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/catalog/add-product.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Add Product</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Edit Product</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/catalog/add-category.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Add Category</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/catalog/edit-category.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Edit Category</span>
                                    ...
                                    <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-accordion">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/sales/listing.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Orders Listing</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/sales/details.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Order Details</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/sales/add-order.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Add Order</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/sales/edit-order.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Edit Order</span>
                                    ...
                                    <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-accordion">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/customers/listing.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/customers/details.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Customers
                                    ...
                                    <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-accordion">
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/reports/view.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Products Viewed</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/reports/sales.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Sales</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/reports/returns.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Returns</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/reports/customer-orders.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Customer Orders</span>
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/reports/shipping.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Shipping</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/ecommerce/settings.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Settings</span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/contacts/getting-started.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Getting Started</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/contacts/add-contact.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Add Contact</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/contacts/edit-contact.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Edit Contact</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/contacts/view-contact.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">View Contact</span>
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                      ...
                                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        ...
                                        <div className="menu-item">
                                          <a className="menu-link py-3" href="../../demo1/dist/apps/invoices/view/invoice-3.html">
                                            <span className="menu-bullet">
                                              <span className="bullet bullet-dot" />
                                            </span>
                                            <span className="menu-title">Invoice 3</span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/file-manager/folders.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Folders</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/file-manager/files.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Files</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/file-manager/blank.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Blank Directory</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/file-manager/settings.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Settings</span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/inbox/listing.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Messages</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/inbox/compose.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Compose</span>
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/apps/inbox/reply.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">View &amp; Reply</span>
                                ...
                                <div className="menu-item">
                                  <a className="menu-link py-3" href="../../demo1/dist/apps/calendar.html">
                                    <span className="menu-icon">
                                      {/*begin::Svg Icon | path: icons/duotune/general/gen014.svg*/}
                                      <span className="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                              ...
                              <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/layouts/toolbars/no-toolbar.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">No Toolbar</span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-dropdown">
                                  ...
                                  <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                    ...
                                    <div className="menu-item">
                                      <a className="menu-link py-3" href="../../demo1/dist/layouts/aside/only-header.html">
                                        <span className="menu-bullet">
                                          <span className="bullet bullet-dot" />
                                        </span>
                                        <span className="menu-title">Only Header</span>
                      ...
                      <div className="d-flex align-items-stretch flex-shrink-0">
                        ...
                        <div className="d-flex align-items-stretch ms-1 ms-lg-3">
                          ...
                          <div id="kt_header_search" className="header-search d-flex align-items-stretch" data-kt-search-keypress="true" data-kt-search-min-length={2} data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-overflow="false" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end">
                            ...
                            <div className="d-flex align-items-center" data-kt-search-element="toggle" id="kt_header_search_toggle">
                              <div className="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px">
                            ...
                            <div data-kt-search-element="content" className="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                              ...
                              <div data-kt-search-element="wrapper">
                                  ...
                                  <div className="scroll-y mh-200px mh-lg-350px">
                                    ...
                                    <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                      ...
                                      <div className="d-flex flex-column justify-content-start fw-bold">
                                        ...
                                        <span className="fs-7 fw-bold text-muted">Marketing
                                          Manager</span>
                                      </div>
                                      {/*end::Title*/}
                                    </a>
                                    ...
                                    <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                      ...
                                      <div className="d-flex flex-column justify-content-start fw-bold">
                                        ...
                                        <span className="fs-7 fw-bold text-muted">Software
                                          Engineer</span>
                                      </div>
                                      {/*end::Title*/}
                                    </a>
                                    ...
                                    <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                      ...
                                      <div className="d-flex flex-column justify-content-start fw-bold">
                                        ...
                                        <span className="fs-7 fw-bold text-muted">UI/UX
                                          Designer</span>
                                      </div>
                                      {/*end::Title*/}
                                    </a>
                                    ...
                                    <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                      ...
                                      <div className="d-flex flex-column justify-content-start fw-bold">
                                        ...
                                        <span className="fs-7 fw-bold text-muted">Art
                                          Director</span>
                                      </div>
                                      {/*end::Title*/}
                                    </a>
                                    ...
                                    <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                      ...
                                      <div className="d-flex flex-column justify-content-start fw-bold">
                                        ...
                                        <span className="fs-7 fw-bold text-muted">System
                                          Administrator</span>
                                      </div>
                                      {/*end::Title*/}
                                    </a>
                                    ...
                                    <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                      ...
                                      <div className="d-flex flex-column justify-content-start fw-bold">
                                        ...
                                        <span className="fs-7 fw-bold text-muted">Web
                                          Development</span>
                                      </div>
                                      {/*end::Title*/}
                                    </a>
                                    ...
                                    <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                      ...
                                      <div className="d-flex flex-column justify-content-start fw-bold">
                                        ...
                                        <span className="fs-7 fw-bold text-muted">Google
                                          Adwords</span>
                                      </div>
                                      {/*end::Title*/}
                                    </a>
                                    ...
                                    <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                      ...
                                      <div className="d-flex flex-column">
                                        <span className="fs-6 fw-bold">Si-Fi Project by AU
                                          Themes</span>
                                    ...
                                    <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="d-flex flex-column">
                                        <span className="fs-6 fw-bold">Shopix Mobile App
                                          Planning</span>
                                    ...
                                    <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="d-flex flex-column">
                                        <span className="fs-6 fw-bold">Finance Monitoring SAAS
                                          Discussion</span>
                                    ...
                                    <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="d-flex flex-column">
                                        <span className="fs-6 fw-bold">Dashboard Analitics
                                          Launch</span>
                                ...
                                <div className="mb-5" data-kt-search-element="main">
                                  ...
                                  <div className="scroll-y mh-200px mh-lg-325px">
                                    ...
                                    <div className="d-flex align-items-center mb-5">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="d-flex flex-column">
                                        <a href="#" className="fs-6 text-gray-800 text-hover-primary fw-bold">BoomApp
                                          by Keenthemes</a>
                                    ...
                                    <div className="d-flex align-items-center mb-5">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="d-flex flex-column">
                                        <a href="#" className="fs-6 text-gray-800 text-hover-primary fw-bold">"Kept
                                    ...
                                    <div className="d-flex align-items-center mb-5">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="d-flex flex-column">
                                        <a href="#" className="fs-6 text-gray-800 text-hover-primary fw-bold">"KPI
                                    ...
                                    <div className="d-flex align-items-center mb-5">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="d-flex flex-column">
                                        <a href="#" className="fs-6 text-gray-800 text-hover-primary fw-bold">"FitPro
                                          App Development</a>
                                        <span className="fs-7 text-muted fw-bold">#84250</span>
                                      </div>
                                      {/*end::Title*/}
                                    ...
                                    <div className="d-flex align-items-center mb-5">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="d-flex flex-column">
                                        <a href="#" className="fs-6 text-gray-800 text-hover-primary fw-bold">Shopix
                                          Mobile App</a>
                                    ...
                                    <div className="d-flex align-items-center mb-5">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="d-flex flex-column">
                                        <a href="#" className="fs-6 text-gray-800 text-hover-primary fw-bold">"Landing
                                          UI Design" Launch</a>
                                ...
                                <div data-kt-search-element="empty" className="text-center d-none">
                                  ...
                                  <div className="pb-15 fw-bold">
                                    ...
                                    <div className="text-muted fs-7">Please try again with a different
                                      query</div>
                                  </div>
                                  {/*end::Message*/}
                                </div>
                              ...
                              <form data-kt-search-element="preferences" className="pt-1 d-none">
                                ...
                                <div className="d-flex justify-content-end pt-7">
                                  ...
                                  <button type="submit" className="btn btn-sm fw-bolder btn-primary">Save
                                    Changes</button>
                                </div>
                                {/*end::Actions*/}
                              </form>
                        ...
                        <div className="d-flex align-items-center ms-1 ms-lg-3">
                          {/*begin::Drawer toggle*/}
                          <div className="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" id="kt_activities_toggle">
                            {/*begin::Svg Icon | path: icons/duotune/general/gen032.svg*/}
                            <span className="svg-icon svg-icon-1">
                              <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                <rect x={8} y={9} width={3} height={10} rx="1.5" fill="currentColor" />
                        ...
                        <div className="d-flex align-items-center ms-1 ms-lg-3">
                          {/*begin::Menu- wrapper*/}
                          <div className="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                            {/*begin::Svg Icon | path: icons/duotune/general/gen022.svg*/}
                            <span className="svg-icon svg-icon-1">
                              <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                <path d="M11.2929 2.70711C11.6834 2.31658 12.3166 2.31658 12.7071 2.70711L15.2929 5.29289C15.6834 5.68342 15.6834 6.31658 15.2929 6.70711L12.7071 9.29289C12.3166 9.68342 11.6834 9.68342 11.2929 9.29289L8.70711 6.70711C8.31658 6.31658 8.31658 5.68342 8.70711 5.29289L11.2929 2.70711Z" fill="currentColor" />
                                ...
                                <div className="scroll-y mh-325px my-5 px-8">
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center">
                                      ...
                                      <div className="mb-0 me-2">
                                        <a href="#" className="fs-6 text-gray-800 text-hover-primary fw-bolder">Project
                                          Alice</a>
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="mb-0 me-2">
                                        <a href="#" className="fs-6 text-gray-800 text-hover-primary fw-bolder">HR
                                          Confidential</a>
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="mb-0 me-2">
                                        <a href="#" className="fs-6 text-gray-800 text-hover-primary fw-bolder">Company
                                          HR</a>
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="mb-0 me-2">
                                        <a href="#" className="fs-6 text-gray-800 text-hover-primary fw-bolder">Banner
                                          Assets</a>
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center">
                                      ...
                                      {/*begin::Title*/}
                                      <div className="mb-0 me-2">
                                        <a href="#" className="fs-6 text-gray-800 text-hover-primary fw-bolder">Icon
                                          Assets</a>
                              ...
                              <div className="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                                ...
                                <div className="d-flex flex-column px-9">
                                  ...
                                  <div className="pt-10 pb-0">
                                    ...
                                    {/*end::Title*/}
                                    {/*begin::Text*/}
                                    <div className="text-center text-gray-600 fw-bold pt-1">Outlines
                                ...
                                <div className="scroll-y mh-325px my-5 px-8">
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center me-2">
                                      ...
                                      {/*end::Code*/}
                                      {/*begin::Title*/}
                                      <a href="#" className="text-gray-800 text-hover-primary fw-bold">New
                                        order</a>
                                      {/*end::Title*/}
                                    </div>
                                    {/*end::Section*/}
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center me-2">
                                      ...
                                      {/*end::Code*/}
                                      {/*begin::Title*/}
                                      <a href="#" className="text-gray-800 text-hover-primary fw-bold">Payment
                                        process</a>
                                      {/*end::Title*/}
                                    </div>
                                    {/*end::Section*/}
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center me-2">
                                      ...
                                      {/*end::Code*/}
                                      {/*begin::Title*/}
                                      <a href="#" className="text-gray-800 text-hover-primary fw-bold">Search
                                        query</a>
                                      {/*end::Title*/}
                                    </div>
                                    {/*end::Section*/}
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center me-2">
                                      ...
                                      {/*end::Code*/}
                                      {/*begin::Title*/}
                                      <a href="#" className="text-gray-800 text-hover-primary fw-bold">API
                                        connection</a>
                                      {/*end::Title*/}
                                    </div>
                                    {/*end::Section*/}
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center me-2">
                                      ...
                                      {/*end::Code*/}
                                      {/*begin::Title*/}
                                      <a href="#" className="text-gray-800 text-hover-primary fw-bold">Database
                                        restore</a>
                                      {/*end::Title*/}
                                    </div>
                                    {/*end::Section*/}
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center me-2">
                                      ...
                                      {/*end::Code*/}
                                      {/*begin::Title*/}
                                      <a href="#" className="text-gray-800 text-hover-primary fw-bold">System
                                        update</a>
                                      {/*end::Title*/}
                                    </div>
                                    {/*end::Section*/}
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center me-2">
                                      ...
                                      {/*end::Code*/}
                                      {/*begin::Title*/}
                                      <a href="#" className="text-gray-800 text-hover-primary fw-bold">Server
                                        OS update</a>
                                      {/*end::Title*/}
                                    </div>
                                    {/*end::Section*/}
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center me-2">
                                      ...
                                      {/*end::Code*/}
                                      {/*begin::Title*/}
                                      <a href="#" className="text-gray-800 text-hover-primary fw-bold">Refund
                                        process</a>
                                      {/*end::Title*/}
                                    </div>
                                    {/*end::Section*/}
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center me-2">
                                      ...
                                      {/*end::Code*/}
                                      {/*begin::Title*/}
                                      <a href="#" className="text-gray-800 text-hover-primary fw-bold">Withdrawal
                                        process</a>
                                      {/*end::Title*/}
                                    </div>
                                    {/*end::Section*/}
                                  ...
                                  <div className="d-flex flex-stack py-4">
                                    ...
                                    <div className="d-flex align-items-center me-2">
                                      ...
                                      {/*end::Code*/}
                                      {/*begin::Title*/}
                                      <a href="#" className="text-gray-800 text-hover-primary fw-bold">Mail
                                        tasks</a>
                                      {/*end::Title*/}
                                    </div>
                                    {/*end::Section*/}
                        ...
                        <div className="d-flex align-items-center ms-1 ms-lg-3">
                          {/*begin::Menu wrapper*/}
                          <div className="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px position-relative" id="kt_drawer_chat_toggle">
                            {/*begin::Svg Icon | path: icons/duotune/communication/com012.svg*/}
                            <span className="svg-icon svg-icon-1">
                              <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                <path opacity="0.3" d="M20 3H4C2.89543 3 2 3.89543 2 5V16C2 17.1046 2.89543 18 4 18H4.5C5.05228 18 5.5 18.4477 5.5 19V21.5052C5.5 22.1441 6.21212 22.5253 6.74376 22.1708L11.4885 19.0077C12.4741 18.3506 13.6321 18 14.8167 18H20C21.1046 18 22 17.1046 22 16V5C22 3.89543 21.1046 3 20 3Z" fill="currentColor" />
                        ...
                        <div className="d-flex align-items-center ms-1 ms-lg-3">
                          ...
                          <div className="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                            ...
                            <div className="row g-0">
                              {/*begin:Item*/}
                              <div className="col-6">
                                <a href="../../demo1/dist/apps/projects/budget.html" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                              ...
                              {/*begin:Item*/}
                              <div className="col-6">
                                <a href="../../demo1/dist/apps/projects/settings.html" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
                                  {/*begin::Svg Icon | path: icons/duotune/communication/com010.svg*/}
                                  <span className="svg-icon svg-icon-3x svg-icon-primary mb-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                      <path d="M6 8.725C6 8.125 6.4 7.725 7 7.725H14L18 11.725V12.925L22 9.725L12.6 2.225C12.2 1.925 11.7 1.925 11.4 2.225L2 9.725L6 12.925V8.725Z" fill="currentColor" />
                              ...
                              {/*begin:Item*/}
                              <div className="col-6">
                                <a href="../../demo1/dist/apps/projects/list.html" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
                                  {/*begin::Svg Icon | path: icons/duotune/abstract/abs042.svg*/}
                                  <span className="svg-icon svg-icon-3x svg-icon-primary mb-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                      <path d="M18 21.6C16.6 20.4 9.1 20.3 6.3 21.2C5.7 21.4 5.1 21.2 4.7 20.8L2 18C4.2 15.8 10.8 15.1 15.8 15.8C16.2 18.3 17 20.5 18 21.6ZM18.8 2.8C18.4 2.4 17.8 2.20001 17.2 2.40001C14.4 3.30001 6.9 3.2 5.5 2C6.8 3.3 7.4 5.5 7.7 7.7C9 7.9 10.3 8 11.7 8C15.8 8 19.8 7.2 21.5 5.5L18.8 2.8Z" fill="currentColor" />
                              ...
                              {/*begin:Item*/}
                              <div className="col-6">
                                <a href="../../demo1/dist/apps/projects/users.html" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
                                  {/*begin::Svg Icon | path: icons/duotune/finance/fin006.svg*/}
                                  <span className="svg-icon svg-icon-3x svg-icon-primary mb-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                      <path opacity="0.3" d="M20 15H4C2.9 15 2 14.1 2 13V7C2 6.4 2.4 6 3 6H21C21.6 6 22 6.4 22 7V13C22 14.1 21.1 15 20 15ZM13 12H11C10.5 12 10 12.4 10 13V16C10 16.5 10.4 17 11 17H13C13.6 17 14 16.6 14 16V13C14 12.4 13.6 12 13 12Z" fill="currentColor" />
                        ...
                        <div className="d-flex align-items-center ms-1 ms-lg-3">
                          ...
                          <a className="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" href="../../demo1/dist/documentation/getting-started/dark-mode.html">
                  ...
                  <div className="toolbar" id="kt_toolbar">
                    ...
                    <div id="kt_toolbar_container" className="container-fluid d-flex flex-stack">
                      ...
                      <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" className="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                        {/*begin::Title*/}
                        <h1 className="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Blog Post</h1>
                        {/*end::Title*/}
                        {/*begin::Separator*/}
                      ...
                      <div className="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div className="m-0">
                          ...
                          {/*end::Menu toggle*/}
                          {/*begin::Menu 1*/}
                          <div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_624476599bf43">
                            {/*begin::Header*/}
                            ...
                            <div className="px-7 py-5">
                              ...
                              <div className="mb-10">
                                ...
                                {/*begin::Input*/}
                                <div>
                                  <select className="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_624476599bf43" data-allow-clear="true">
                                    <option />
                        ...
                        <div className="card-body p-lg-20 pb-lg-0">
                            ...
                            <div className="flex-lg-row-fluid me-xl-15">
                              ...
                              <div className="mb-17">
                                ...
                                <div className="mb-8">
                                  ...
                                  {/*end::Info*/}
                                  {/*begin::Title*/}
                                  <a href="#" className="text-dark text-hover-primary fs-2 fw-bolder">Admin Panel
                                    - How To Get Started Tutorial. Create a customizable SaaS Based
                                    applications and solutions
                                    <span className="fw-bolder text-muted fs-5 ps-1">5 mins
                                      read</span></a>
                                  {/*end::Title*/}
                                  {/*begin::Container*/}
                                  <div className="overlay mt-8">
                                    {/*begin::Image*/}
                                    <div className="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px" style={{ backgroundImage: 'url("assets/media/stock/1600x800/img-1.jpg")' }}>
                                    </div>
                                    {/*end::Image*/}
                                    {/*begin::Links*/}
                                    <div className="overlay-layer card-rounded bg-dark bg-opacity-25">
                                      <a href="../../demo1/dist/pages/about.html" className="btn btn-primary">About Us</a>
                                      <a href="../../demo1/dist/pages/careers/apply.html" className="btn btn-light-primary ms-3">Join Us</a>
                                    </div>
                                    {/*end::Links*/}
                                  </div>
                                  {/*end::Container*/}
                                ...
                                <div className="fs-5 fw-bold text-gray-600">
                                  {/*begin::Text*/}
                                  <p className="mb-8">First, a disclaimer – the entire process of writing
                                    a blog post often takes more than a couple of hours, even if you
                                    can type eighty words per minute and your writing skills are
                                    sharp. From the seed of the idea to finally hitting “Publish,”
                                    you might spend several days or maybe even a week “writing” a
                                    blog post, but it’s important to spend those vital hours
                                    planning your post and even thinking about
                                    <a href="../../demo1/dist/pages/blog/post.html" className="link-primary pe-1">Your Post</a>(yes, thinking counts
                                    as working if you’re a blogger) before you actually write it.
                                  </p>
                                  {/*end::Text*/}
                                  {/*begin::Text*/}
                                  <p className="mb-8">There’s an old maxim that states,
                                    <span className="text-gray-800 pe-1">“No fun for the writer, no fun
                                      for the reader.”</span>No matter what industry you’re
                                    working in, as a blogger, you should live and die by this
                                    statement.
                                  </p>
                                  {/*end::Text*/}
                                  {/*begin::Text*/}
                                  <p className="mb-8">Before you do any of the following steps, be sure to
                                    pick a topic that actually interests you. Nothing – and
                                    <a href="../../demo1/dist/pages/blog/home.html" className="link-primary pe-1">I mean NOTHING</a>– will kill a
                                    blog post more effectively than a lack of enthusiasm from the
                                    writer. You can tell when a writer is bored by their subject,
                                    and it’s so cringe-worthy it’s a little embarrassing.
                                  </p>
                                  {/*end::Text*/}
                                  {/*begin::Text*/}
                                  <p className="mb-17">I can hear your objections already. “But Dan, I
                                    have to blog for a cardboard box manufacturing company.” I feel
                                    your pain, I really do. During the course of my career, I’ve
                                    written content for dozens of clients in some
                                    less-than-thrilling industries (such as financial regulatory
                                    compliance and corporate housing), but the hallmark of a
                                    professional blogger is the ability to write well about any
                                    topic, no matter how dry it may be. Blogging is a lot easier,
                                    however, if you can muster at least a little enthusiasm for the
                                    topic at hand.</p>
                                  {/*end::Text*/}
                                </div>
                                {/*end::Description*/}
                                ...
                                <div className="d-flex align-items-center border-1 border-dashed card-rounded p-5 p-lg-10 mb-14">
                                  ...
                                  <div className="text-center flex-shrink-0 me-7 me-lg-13">
                                    ...
                                    {/*begin::Info*/}
                                    <div className="mb-0">
                                      <a href="../../demo1/dist/pages/user-profile/overview.html" className="text-gray-700 fw-bolder text-hover-primary">Jane
                                        Johnson</a>
                                  ...
                                  <div className="mb-0 fs-6">
                                    <div className="text-muted fw-bold lh-lg mb-2">First, a disclaimer –
                                      the entire process of writing a blog post often takes more
                                      than a couple of hours, even if you can type eighty words
                                      per minute and your writing skills are sharp writing a blog
                                      post often takes more than a couple.</div>
                                    <a href="../../demo1/dist/pages/user-profile/overview.html" className="fw-bold link-primary">Author’s Profile</a>
                                  </div>
                                  {/*end::Text*/}
                                </div>
                                {/*end::Block*/}
                            ...
                            <div className="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                              ...
                              <div className="mb-16">
                                ...
                                <div className="d-flex flex-stack fw-bold fs-5 text-muted mb-4">
                                  {/*begin::Text*/}
                                  <a href="#" className="text-muted text-hover-primary pe-2">SaaS
                                    Solutions</a>
                                  {/*end::Text*/}
                                  {/*begin::Number*/}
                                ...
                                <div className="d-flex flex-stack fw-bold fs-5 text-muted mb-4">
                                  {/*begin::Text*/}
                                  <a href="#" className="text-muted text-hover-primary pe-2">Company
                                    News</a>
                                  {/*end::Text*/}
                                  {/*begin::Number*/}
                                ...
                                <div className="d-flex flex-stack fw-bold fs-5 text-muted mb-4">
                                  {/*begin::Text*/}
                                  <a href="#" className="text-muted text-hover-primary pe-2">Events &amp;
                                    Activities</a>
                                  {/*end::Text*/}
                                  {/*begin::Number*/}
                                ...
                                <div className="d-flex flex-stack fw-bold fs-5 text-muted mb-4">
                                  {/*begin::Text*/}
                                  <a href="#" className="text-muted text-hover-primary pe-2">Support
                                    Related</a>
                                  {/*end::Text*/}
                                  {/*begin::Number*/}
                                ...
                                <div className="d-flex flex-stack fw-bold fs-5 text-muted">
                                  {/*begin::Text*/}
                                  <a href="#" className="text-muted text-hover-primary pe-2">Product
                                    Updates</a>
                                  {/*end::Text*/}
                                  {/*begin::Number*/}
                              ...
                              <div className="m-0">
                                ...
                                <div className="d-flex flex-stack mb-7">
                                  ...
                                  {/*begin::Title*/}
                                  <div className="m-0">
                                    <a href="#" className="text-dark fw-bolder text-hover-primary fs-6">About
                                      Bootstrap Admin</a>
                                    <span className="text-gray-600 fw-bold d-block pt-1 fs-7">We’ve been
                                      a focused on making a the sky</span>
                                  </div>
                                  {/*end::Title*/}
                                </div>
                                {/*end::Item*/}
                                ...
                                <div className="d-flex flex-stack mb-7">
                                  ...
                                  {/*begin::Title*/}
                                  <div className="m-0">
                                    <a href="#" className="text-dark fw-bolder text-hover-primary fs-6">A yellow
                                      sofa</a>
                                    <span className="text-gray-600 fw-bold d-block pt-1 fs-7">We’ve been
                                      a focused on making a the sky</span>
                                  </div>
                                ...
                                <div className="d-flex flex-stack mb-7">
                                  ...
                                  {/*begin::Title*/}
                                  <div className="m-0">
                                    <a href="#" className="text-dark fw-bolder text-hover-primary fs-6">Our
                                      Camra Mega Set</a>
                                    <span className="text-gray-600 fw-bold d-block pt-1 fs-7">We’ve been
                                      a focused on making a the sky</span>
                                  </div>
                                ...
                                <div className="d-flex flex-stack">
                                  ...
                                  {/*begin::Title*/}
                                  <div className="m-0">
                                    <a href="#" className="text-dark fw-bolder text-hover-primary fs-6">Time to
                                      cook and eat?</a>
                                    <span className="text-gray-600 fw-bold d-block pt-1 fs-7">We’ve been
                                      a focused on making a the sky</span>
                                  </div>
                          ...
                          <div className="mb-17">
                            ...
                            <div className="d-flex flex-stack mb-5">
                              ...
                              {/*end::Title*/}
                              {/*begin::Link*/}
                              <a href="#" className="fs-6 fw-bold link-primary">View All Videos</a>
                              {/*end::Link*/}
                            </div>
                            {/*end::Content*/}
                            {/*begin::Separator*/}
                            ...
                            <div className="row g-10">
                              ...
                              <div className="col-md-4">
                                ...
                                <div className="card-xl-stretch me-md-6">
                                  ...
                                  <div className="m-0">
                                    {/*begin::Title*/}
                                    <a href="../../demo1/dist/pages/user-profile/overview.html" className="fs-4 text-dark fw-bolder text-hover-primary text-dark lh-base">Admin
                                      Panel - How To Started the Dashboard Tutorial</a>
                                    {/*end::Title*/}
                                    {/*begin::Text*/}
                                    <div className="fw-bold fs-5 text-gray-600 text-dark my-4">We’ve
                                      been focused on making a the from also not been afraid to
                                      and step away been focused create eye</div>
                                    {/*end::Text*/}
                                    {/*begin::Content*/}
                                    <div className="fs-6 fw-bolder">
                                      {/*begin::Author*/}
                                      <a href="../../demo1/dist/pages/user-profile/overview.html" className="text-gray-700 text-hover-primary">Jane Miller</a>
                                      {/*end::Author*/}
                                      {/*begin::Date*/}
                              ...
                              <div className="col-md-4">
                                ...
                                <div className="card-xl-stretch mx-md-3">
                                  ...
                                  <div className="m-0">
                                    ...
                                    {/*begin::Text*/}
                                    <div className="fw-bold fs-5 text-gray-600 text-dark my-4">We’ve
                                      been focused on making the from v4 to v5 but we have also
                                      not been afraid to step away been focused</div>
                                    {/*end::Text*/}
                                    {/*begin::Content*/}
                                    <div className="fs-6 fw-bolder">
                                      {/*begin::Author*/}
                                      <a href="../../demo1/dist/pages/user-profile/overview.html" className="text-gray-700 text-hover-primary">Cris Morgan</a>
                                      {/*end::Author*/}
                                      {/*begin::Date*/}
                              ...
                              <div className="col-md-4">
                                ...
                                <div className="card-xl-stretch ms-md-6">
                                  ...
                                  <div className="m-0">
                                    ...
                                    {/*begin::Text*/}
                                    <div className="fw-bold fs-5 text-gray-600 text-dark my-4">We’ve
                                      been focused on making the from v4 to v5 but we’ve also not
                                      been afraid to step away been focused</div>
                                    {/*end::Text*/}
                                    {/*begin::Content*/}
                                    <div className="fs-6 fw-bolder">
                                      {/*begin::Author*/}
                                      <a href="../../demo1/dist/pages/user-profile/overview.html" className="text-gray-700 text-hover-primary">Carles
                                        Nilson</a>
                                      {/*end::Author*/}
                                      {/*begin::Date*/}
                          ...
                          <div className="mb-17">
                            ...
                            <div className="d-flex flex-stack mb-5">
                              ...
                              {/*end::Title*/}
                              {/*begin::Link*/}
                              <a href="#" className="fs-6 fw-bold link-primary">View All Offers</a>
                              {/*end::Link*/}
                            </div>
                            {/*end::Content*/}
                            {/*begin::Separator*/}
                            ...
                            <div className="row g-10">
                              ...
                              <div className="col-md-4">
                                ...
                                <div className="card-xl-stretch me-md-6">
                                  {/*begin::Overlay*/}
                                  <a className="d-block overlay" data-fslightbox="lightbox-hot-sales" href="assets/media/stock/600x400/img-23.jpg">
                                    {/*begin::Image*/}
                                  ...
                                  <div className="mt-5">
                                    {/*begin::Title*/}
                                    <a href="#" className="fs-4 text-dark fw-bolder text-hover-primary text-dark lh-base">25
                                      Products Mega Bundle with 50% off discount amazing</a>
                                    {/*end::Title*/}
                                    {/*begin::Text*/}
                                    <div className="fw-bold fs-5 text-gray-600 text-dark mt-3">We’ve
                                      been focused on making a the from also not been eye</div>
                                    {/*end::Text*/}
                                    {/*begin::Text*/}
                              ...
                              <div className="col-md-4">
                                ...
                                <div className="card-xl-stretch mx-md-3">
                                  {/*begin::Overlay*/}
                                  <a className="d-block overlay" data-fslightbox="lightbox-hot-sales" href="assets/media/stock/600x600/img-14.jpg">
                                    {/*begin::Image*/}
                              ...
                              <div className="col-md-4">
                                ...
                                <div className="card-xl-stretch ms-md-6">
                                  {/*begin::Overlay*/}
                                  <a className="d-block overlay" data-fslightbox="lightbox-hot-sales" href="assets/media/stock/600x400/img-71.jpg">
                                    {/*begin::Image*/}
          ...
          <div id="kt_activities" className="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
            <div className="card shadow-none rounded-0">
                    ...
                    <div className="timeline-item">
                      ...
                      <div className="timeline-content mb-10 mt-n1">
                        ...
                        <div className="pe-3 mb-5">
                          {/*begin::Title*/}
                          <div className="fs-5 fw-bold mb-2">There are 2 new tasks for you in “AirPlus Mobile App”
                            project:</div>
                          {/*end::Title*/}
                          {/*begin::Description*/}
                        ...
                        <div className="overflow-auto pb-5">
                          ...
                          <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                            {/*begin::Title*/}
                            <a href="../../demo1/dist/apps/projects/project.html" className="fs-5 text-dark text-hover-primary fw-bold w-375px min-w-200px">Meeting
                              with customer</a>
                            {/*end::Title*/}
                            {/*begin::Label*/}
                            ...
                            <div className="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                              ...
                              {/*begin::User*/}
                              <div className="symbol symbol-circle symbol-25px">
                                <div className="symbol-label fs-8 fw-bold bg-primary text-inverse-primary">A
                                </div>
                              </div>
                              {/*end::User*/}
                            </div>
                          ...
                          <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                            {/*begin::Title*/}
                            <a href="../../demo1/dist/apps/projects/project.html" className="fs-5 text-dark text-hover-primary fw-bold w-375px min-w-200px">Project
                            ...
                            <div className="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                              ...
                              {/*begin::User*/}
                              <div className="symbol symbol-circle symbol-25px">
                                <div className="symbol-label fs-8 fw-bold bg-success text-inverse-primary">B
                                </div>
                              </div>
                              {/*end::User*/}
                            </div>
                    ...
                    <div className="timeline-item">
                      ...
                      <div className="timeline-content mb-10 mt-n2">
                        ...
                        <div className="overflow-auto pe-3">
                          {/*begin::Title*/}
                          <div className="fs-5 fw-bold mb-2">Invitation for crafting engaging designs that speak
                            human workshop</div>
                          {/*end::Title*/}
                          {/*begin::Description*/}
                          <div className="d-flex align-items-center mt-1 fs-6">
                    ...
                    <div className="timeline-item">
                      ...
                      <div className="timeline-content mb-10 mt-n1">
                        ...
                        <div className="mb-5 pe-3">
                          {/*begin::Title*/}
                          <a href="#" className="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">3 New
                          ...
                          <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                            ...
                            <div className="d-flex flex-aligns-center pe-10 pe-lg-20">
                              ...
                              <div className="ms-1 fw-bold">
                                {/*begin::Desc*/}
                                <a href="../../demo1/dist/apps/projects/project.html" className="fs-6 text-hover-primary fw-bolder">Finance KPI App
                                  Guidelines</a>
                                {/*end::Desc*/}
                                {/*begin::Number*/}
                            ...
                            <div className="d-flex flex-aligns-center pe-10 pe-lg-20">
                              ...
                              <div className="ms-1 fw-bold">
                                {/*begin::Desc*/}
                                <a href="#" className="fs-6 text-hover-primary fw-bolder">Client UAT Testing
                                  Results</a>
                                {/*end::Desc*/}
                                {/*begin::Number*/}
                            ...
                            <div className="d-flex flex-aligns-center">
                              ...
                              <div className="ms-1 fw-bold">
                                {/*begin::Desc*/}
                                <a href="#" className="fs-6 text-hover-primary fw-bolder">Finance
                                  Reports</a>
                                {/*end::Desc*/}
                                {/*begin::Number*/}
                      ...
                      <div className="timeline-content mb-10 mt-n1">
                        ...
                        <div className="pe-3 mb-5">
                          ...
                          <div className="fs-5 fw-bold mb-2">Task
                            ...
                            <a href="#" className="text-primary fw-bolder me-1">#45890</a>in “Ads Pro Admin
                            Dashboard project:
                          </div>
                          {/*end::Title*/}
                          {/*begin::Description*/}
                      ...
                      <div className="timeline-content mb-10 mt-n1">
                        ...
                        <div className="pe-3 mb-5">
                          ...
                          <div className="fs-5 fw-bold mb-2">New case
                            <a href="#" className="text-primary fw-bolder me-1">#67890</a>is assigned to you in
                          ...
                          <div className="notice d-flex bg-light-primary rounded border-primary border border-dashed min-w-lg-600px flex-shrink-0 p-6">
                            ...
                            <div className="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                              ...
                              <div className="mb-3 mb-md-0 fw-bold">
                                <h4 className="text-gray-900 fw-bolder">Database Backup Process Completed!
                                </h4>
                                <div className="fs-6 text-gray-700 pe-7">Login into Admin Dashboard to make
                      ...
                      <div className="timeline-content mt-n1">
                        ...
                        <div className="pe-3 mb-5">
                          ...
                          <div className="fs-5 fw-bold mb-2">New order
                            <a href="#" className="text-primary fw-bolder me-1">#67890</a>is placed for Workshow
              ...
              <div className="card-footer py-5 text-center" id="kt_activities_footer">
                <a href="../../demo1/dist/pages/user-profile/activity.html" className="btn btn-bg-body text-primary">View
                  All Activities
                  {/*begin::Svg Icon | path: icons/duotune/arrows/arr064.svg*/}
              ...
              <div className="card-header pe-5" id="kt_drawer_chat_messenger_header">
                ...
                <div className="card-title">
                  ...
                  <div className="d-flex justify-content-center flex-column me-3">
                    <a href="#" className="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 mb-2 lh-1">Brian Cox</a>
                    {/*begin::Info*/}
                ...
                <div className="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_drawer_chat_messenger_header, #kt_drawer_chat_messenger_footer" data-kt-scroll-wrappers="#kt_drawer_chat_messenger_body" data-kt-scroll-offset="0px">
                  ...
                  <div className="d-flex justify-content-start mb-10">
                    ...
                    <div className="d-flex flex-column align-items-start">
                      ...
                      <div className="d-flex align-items-center mb-2">
                        ...
                        {/*begin::Details*/}
                        <div className="ms-3">
                          <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary me-1">Brian
                            Cox</a>
                      ...
                      {/*end::User*/}
                      {/*begin::Text*/}
                      <div className="p-5 rounded bg-light-info text-dark fw-bold mw-lg-400px text-start" data-kt-element="message-text">How likely are you to recommend our company to your
                  ...
                  <div className="d-flex justify-content-end mb-10">
                    ...
                    <div className="d-flex flex-column align-items-end">
                      ...
                      {/*end::User*/}
                      {/*begin::Text*/}
                      <div className="p-5 rounded bg-light-primary text-dark fw-bold mw-lg-400px text-end" data-kt-element="message-text">Hey there, we’re just writing to let you know that you’ve
                  ...
                  <div className="d-flex justify-content-end mb-10">
                    ...
                    <div className="d-flex flex-column align-items-end">
                      ...
                      {/*end::User*/}
                      {/*begin::Text*/}
                      <div className="p-5 rounded bg-light-primary text-dark fw-bold mw-lg-400px text-end" data-kt-element="message-text">You’ll receive notifications for all issues, pull
                        requests!</div>
                      {/*end::Text*/}
                    </div>
                    {/*end::Wrapper*/}
                  ...
                  <div className="d-flex justify-content-start mb-10">
                    ...
                    <div className="d-flex flex-column align-items-start">
                      ...
                      {/*end::User*/}
                      {/*begin::Text*/}
                      <div className="p-5 rounded bg-light-info text-dark fw-bold mw-lg-400px text-start" data-kt-element="message-text">You can unwatch this repository immediately by clicking
                        here:
                  ...
                  <div className="d-flex justify-content-start mb-10">
                    ...
                    <div className="d-flex flex-column align-items-start">
                      ...
                      {/*end::User*/}
                      {/*begin::Text*/}
                      <div className="p-5 rounded bg-light-info text-dark fw-bold mw-lg-400px text-start" data-kt-element="message-text">Company BBQ to celebrate the last quater achievements and
                  ...
                  <div className="d-flex justify-content-start mb-10 d-none" data-kt-element="template-in">
                    ...
                    <div className="d-flex flex-column align-items-start">
                      ...
                      {/*end::User*/}
                      {/*begin::Text*/}
                      <div className="p-5 rounded bg-light-info text-dark fw-bold mw-lg-400px text-start" data-kt-element="message-text">Right before vacation season we have the next Big Deal
                        for you.</div>
                      {/*end::Text*/}
                    </div>
                    {/*end::Wrapper*/}
                      ...
                      <div className="row g-5">
                        ...
                        <div className="col-6">
                          ...
                          <div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                            ...
                            <div className="overlay-layer bg-dark bg-opacity-10">
                              <div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon
                              </div>
                            </div>
                          </div>
                          {/*end::Demo*/}
              ...
              <div className="card-body" id="kt_help_body">
                ...
                <div id="kt_help_scroll" className="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
                  ...
                  <div className="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
                    {/*begin::Heading*/}
                    <h2 className="fw-bolder mb-5">Support at
                      <a href="https://devs.keenthemes.com" className>devs.keenthemes.com</a>
                    </h2>
                    {/*end::Heading*/}
                    {/*begin::Description*/}
                    <div className="fs-5 fw-bold mb-5">
                      <span className="text-gray-500">Join our developers community to find answer to your question
                        and help others.</span>
                      <a className="explore-link d-none" href="https://keenthemes.com/licensing">FAQs</a>
                    </div>
                    {/*end::Description*/}
                    {/*begin::Link*/}
                    <a href="https://devs.keenthemes.com" className="btn btn-lg explore-btn-primary w-100">Get
                      Support</a>
                    {/*end::Link*/}
                  </div>
                  {/*end::Support*/}
                  ...
                  <div className="d-flex align-items-center mb-7">
                    ...
                    <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                      ...
                      <div className="d-flex flex-column me-2 me-lg-5">
                        {/*begin::Title*/}
                        <a href="../../demo1/dist/documentation/getting-started.html" className="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">Documentation &amp;
                          Videos</a>
                        {/*end::Title*/}
                        {/*begin::Description*/}
                        <div className="text-muted fw-bold fs-7 fs-lg-6">From guides and video tutorials, to live
                  ...
                  <div className="d-flex align-items-center mb-7">
                    ...
                    <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                      ...
                      <div className="d-flex flex-column me-2 me-lg-5">
                        {/*begin::Title*/}
                        <a href="../../demo1/dist/documentation/base/utilities.html" className="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">Plugins &amp;
                          Components</a>
                        {/*end::Title*/}
                        {/*begin::Description*/}
                        <div className="text-muted fw-bold fs-7 fs-lg-6">Check out our 300+ in-house components and
                  ...
                  <div className="d-flex align-items-center mb-7">
                    ...
                    <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                      ...
                      <div className="d-flex flex-column me-2 me-lg-5">
                        {/*begin::Title*/}
                        <a href="https://preview.keenthemes.com/metronic8/demo1/layout-builder.html" className="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">Layout Builder</a>
                        {/*end::Title*/}
                        {/*begin::Description*/}
                        <div className="text-muted fw-bold fs-7 fs-lg-6">Build your layout, preview it and export
                  ...
                  <div className="d-flex align-items-center mb-7">
                    ...
                    <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                      ...
                      <div className="d-flex flex-column me-2 me-lg-5">
                        {/*begin::Title*/}
                        <a href="https://devs.keenthemes.com/metronic" className="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">Metronic
                          Downloads</a>
                        {/*end::Title*/}
                        {/*begin::Description*/}
                        <div className="text-muted fw-bold fs-7 fs-lg-6">Download your prefered framework and demo
                          with one click.</div>
                        {/*end::Description*/}
                      </div>
                      {/*end::Wrapper*/}
                  ...
                  <div className="d-flex align-items-center mb-7">
                    ...
                    <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                      ...
                      <div className="d-flex flex-column me-2 me-lg-5">
                        {/*begin::Title*/}
                        <a href="../../demo1/dist/documentation/getting-started/changelog.html" className="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">What's New</a>
                        {/*end::Title*/}
                        {/*begin::Description*/}
                        <div className="text-muted fw-bold fs-7 fs-lg-6">Latest features and improvements added with
                ...
                <div className="modal-body pt-0 pb-15 px-5 px-xl-20">
                  ...
                  <div className="mb-13 text-center">
                    ...
                    <div className="text-muted fw-bold fs-5">If you need more info, please check
                      <a href="#" className="link-primary fw-bolder">Pricing Guidelines</a>.
                    </div>
                  </div>
                  {/*end::Heading*/}
                  {/*begin::Plans*/}
                        ...
                        <div className="nav flex-column">
                          ...
                          <div className="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 active mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_startup">
                            ...
                            <div className="d-flex align-items-center me-2">
                              ...
                              <div className="flex-grow-1">
                                <h2 className="d-flex align-items-center fs-2 fw-bolder flex-wrap">Startup
                                </h2>
                          ...
                          <div className="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_advanced">
                            ...
                            <div className="d-flex align-items-center me-2">
                              ...
                              {/*begin::Info*/}
                              <div className="flex-grow-1">
                                <h2 className="d-flex align-items-center fs-2 fw-bolder flex-wrap">Advanced
                                </h2>
                            ...
                            <div className="d-flex align-items-center me-2">
                              ...
                              <div className="flex-grow-1">
                                <h2 className="d-flex align-items-center fs-2 fw-bolder flex-wrap">
                                  Enterprise
                                  <span className="badge badge-light-success ms-2 fs-7">Most
                                    popular</span>
                                </h2>
                          ...
                          <div className="nav-link btn btn-outline btn-outline-dashed btn-color-dark d-flex flex-stack text-start p-6">
                            ...
                            <div className="d-flex align-items-center me-2">
                              ...
                              {/*begin::Info*/}
                              <div className="flex-grow-1">
                                <h2 className="d-flex align-items-center fs-2 fw-bolder flex-wrap">Custom
                                </h2>
                        ...
                        <div className="tab-content rounded h-100 bg-light p-10">
                          ...
                          <div className="tab-pane fade show active" id="kt_upgrade_plan_startup">
                            ...
                            <div className="pb-5">
                              ...
                              <div className="text-muted fw-bold">Optimal for 10+ team size and new startup
                              </div>
                            </div>
                            {/*end::Heading*/}
                            {/*begin::Body*/}
                            <div className="pt-1">
                              {/*begin::Item*/}
                              <div className="d-flex align-items-center mb-7">
                                <span className="fw-bold fs-5 text-gray-700 flex-grow-1">Up to 10 Active
                                  Users</span>
                              ...
                              {/*begin::Item*/}
                              <div className="d-flex align-items-center mb-7">
                                <span className="fw-bold fs-5 text-gray-700 flex-grow-1">Up to 30 Project
                                  Integrations</span>
                                {/*begin::Svg Icon | path: icons/duotune/general/gen043.svg*/}
                                <span className="svg-icon svg-icon-1 svg-icon-success">
                                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                              ...
                              {/*begin::Item*/}
                              <div className="d-flex align-items-center mb-7">
                                <span className="fw-bold fs-5 text-gray-700 flex-grow-1">Analytics
                                  Module</span>
                                {/*begin::Svg Icon | path: icons/duotune/general/gen043.svg*/}
                                <span className="svg-icon svg-icon-1 svg-icon-success">
                                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                              ...
                              {/*begin::Item*/}
                              <div className="d-flex align-items-center mb-7">
                                <span className="fw-bold fs-5 text-muted flex-grow-1">Accounting
                                  Module</span>
                                {/*begin::Svg Icon | path: icons/duotune/general/gen040.svg*/}
                                <span className="svg-icon svg-icon-1">
                                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                              ...
                              {/*begin::Item*/}
                              <div className="d-flex align-items-center mb-7">
                                <span className="fw-bold fs-5 text-muted flex-grow-1">Network
                                  Platform</span>
                                {/*begin::Svg Icon | path: icons/duotune/general/gen040.svg*/}
                                <span className="svg-icon svg-icon-1">
                                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                              ...
                              {/*begin::Item*/}
                              <div className="d-flex align-items-center">
                                <span className="fw-bold fs-5 text-muted flex-grow-1">Unlimited Cloud
                                  Space</span>
                                {/*begin::Svg Icon | path: icons/duotune/general/gen040.svg*/}
                                <span className="svg-icon svg-icon-1">
                                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                          ...
                          <div className="tab-pane fade" id="kt_upgrade_plan_advanced">
                            ...
                            <div className="pb-5">
                              <h2 className="fw-bolder text-dark">What’s in Startup Plan?</h2>
                              <div className="text-muted fw-bold">Optimal for 100+ team size and grown company
                              </div>
                            </div>
                            {/*end::Heading*/}
                            {/*begin::Body*/}
                            <div className="pt-1">
                              ...
                              {/*begin::Item*/}
                              <div className="d-flex align-items-center mb-7">
                                <span className="fw-bold fs-5 text-gray-700 flex-grow-1">Finance
                                  Module</span>
                                {/*begin::Svg Icon | path: icons/duotune/general/gen043.svg*/}
                                <span className="svg-icon svg-icon-1 svg-icon-success">
                                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                              ...
                              {/*begin::Item*/}
                              <div className="d-flex align-items-center mb-7">
                                <span className="fw-bold fs-5 text-gray-700 flex-grow-1">Accounting
                                  Module</span>
                                {/*begin::Svg Icon | path: icons/duotune/general/gen043.svg*/}
                                <span className="svg-icon svg-icon-1 svg-icon-success">
                                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                          ...
                          <div className="tab-pane fade" id="kt_upgrade_plan_enterprise">
                            ...
                            <div className="pt-1">
                              ...
                              {/*begin::Item*/}
                              <div className="d-flex align-items-center mb-7">
                                <span className="fw-bold fs-5 text-gray-700 flex-grow-1">Network
                                  Platform</span>
                                {/*begin::Svg Icon | path: icons/duotune/general/gen043.svg*/}
                                <span className="svg-icon svg-icon-1 svg-icon-success">
                                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                              ...
                              {/*begin::Item*/}
                              <div className="d-flex align-items-center">
                                <span className="fw-bold fs-5 text-gray-700 flex-grow-1">Unlimited Cloud
                                  Space</span>
                                {/*begin::Svg Icon | path: icons/duotune/general/gen043.svg*/}
                                <span className="svg-icon svg-icon-1 svg-icon-success">
                                  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                      ...
                      <form className="form" noValidate="novalidate" id="kt_modal_create_app_form">
                                ...
                                <label className="d-flex flex-stack mb-5 cursor-pointer">
                                  ...
                                  <span className="d-flex align-items-center me-2">
                                    ...
                                    <span className="d-flex flex-column">
                                      ...
                                      <span className="fs-7 text-muted">Creating a clear text
                              ...
                              <label className="d-flex flex-stack cursor-pointer mb-5">
                                ...
                                <span className="d-flex align-items-center me-2">
                                  ...
                                  <span className="d-flex flex-column">
                                    ...
                                    <span className="fs-7 text-muted">Robust and flexible app
                                      framework</span>
                                  </span>
                                  {/*end:Info*/}
                                </span>
                              ...
                              <label className="d-flex flex-stack cursor-pointer">
                                ...
                                <span className="d-flex align-items-center me-2">
                                  ...
                                  <span className="d-flex flex-column">
                                    ...
                                    <span className="fs-7 text-muted">Lightweight and responsive
                                      framework</span>
                                  </span>
                                  {/*end:Info*/}
                                </span>
                              ...
                              <label className="d-flex flex-stack cursor-pointer mb-5">
                                ...
                                <span className="d-flex align-items-center me-2">
                                  ...
                                  <span className="d-flex flex-column">
                                    ...
                                    <span className="fs-7 text-muted">Google based app data
                                      management</span>
                                  </span>
                                  {/*end::Info*/}
                                </span>
                          ...
                          <div className="w-100">
                            ...
                            <div className="row mb-10">
                              ...
                              <div className="col-md-8 fv-row">
                                {/*begin::Label*/}
                                <label className="required fs-6 fw-bold form-label mb-2">Expiration
                                  Date</label>
                                {/*end::Label*/}
                                {/*begin::Row*/}
                            ...
                            <div className="d-flex flex-stack">
                              {/*begin::Label*/}
                              <div className="me-5">
                                <label className="fs-6 fw-bold form-label">Save Card for further
                                  billing?</label>
                                <div className="fs-7 fw-bold text-muted">If you need more info, please check
                                  budget planning</div>
                              </div>
                              {/*end::Label*/}
                              {/*begin::Switch*/}
                        ...
                        <div data-kt-stepper-element="content">
                          <div className="w-100 text-center">
                            ...
                            {/*end::Heading*/}
                            {/*begin::Description*/}
                            <div className="text-muted fw-bold fs-3">Submit your app to kickstart your project.
                            </div>
                            {/*end::Description*/}
                            {/*begin::Illustration*/}
                    ...
                    <div className="py-5">
                      ...
                      <div data-kt-search-element="results" className="d-none">
                        ...
                        <div className="mh-375px scroll-y me-n7 pe-7">
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={0}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Emma
                                  Smith</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={1}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Melody
                                  Macy</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={2}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Max
                                  Smith</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={3}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Sean
                                  Bean</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={4}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Brian
                                  Cox</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={5}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Mikaela
                                  Collins</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={6}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Francis
                                  Mitcham</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={7}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Olivia
                                  Wild</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={8}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Neil
                                  Owen</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={9}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Dan
                                  Wilson</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={11}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Ana
                                  Crown</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={12}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Robert
                                  Doe</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={13}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">John
                                  Miller</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={14}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Lucy
                                  Kunic</a>
                          ...
                          <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={15}>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {/*begin::Details*/}
                              <div className="ms-5">
                                <a href="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Ethan
                                  Wilder</a>
                        ...
                        <div className="d-flex flex-center mt-15">
                          ...
                          <button type="submit" id="kt_modal_users_search_submit" className="btn btn-primary">Add
              ...
              <div className="modal-content">
                ...
                <div className="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                  ...
                  <div className="btn btn-light-primary fw-bolder w-100 mb-8">
                    <img alt="Logo" src="assets/media/svg/brand-logos/google-icon.svg" className="h-20px me-3" />Invite
                    Gmail Contacts
                  </div>
